...
class AuthStub:
    ...
    def __init__(self, channel):
        ...
        self.RefreshToken = channel.unary_unary(
                ...
                response_deserializer=auth__pb2.RefresResponse.FromString,
                _registered_method=True)
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RefreshToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=auth__pb2.RefresResponse.SerializeToString,
            ),
...
class Auth:
    ...
    def RefreshToken(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.RefresResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
